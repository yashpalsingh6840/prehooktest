...
public class SqlStatementBuilderEmitterTests
{
    ...
    {
        var result = SqlStatementBuilderEmitter.Emit("Generated.Mapping", "SQL_PostLoad", "SQL_PostLoad", "UPDATE dbo.Target SET Name = UPPER(Name);");
    ...
    public void Emit_RoutesTheSqlTextThroughCSharpStringLiteral_SoQuotesAndNewlinesStayValidCSharp()
    {
        ...
        var result = SqlStatementBuilderEmitter.Emit(
            "Generated.Mapping", "SQL_Insert", "SQL_Insert", "INSERT INTO dbo.Log (Msg) VALUES (N'quote\" here')\r\nGO");
    ...
    {
        var result = SqlStatementBuilderEmitter.Emit("Generated.Mapping", "SQL_Task", "SQL_Task", "SELECT 1;");
